...
# Comprobando la existencia de algun elemento
...
# print(lista3.index(0)) # esto daía un error por no ser el elemento parte de la lista
...
diccionario2 = {'Gabriel': {'Edad': 19, 'Altura': 1.80}, 'Santiago': [18, 1.78], 'Fernando': [20, 1.70]}
print(diccionario2)
...
seleccionArgentina = {
    ...
    9: {'Nombre': 'Julián Álvarez', 'Edad': 24, 'Altura': 1.70, 'Precio': '90 Millones', 'Posicion': 'Delantero'},
    5: {'Nombre': 'Leandro Paredes', 'Edad': 30, 'Altura': 1.82, 'Precio': '38 Millones', 'Posicion': 'Mediocampista'},
    13: {'Nombre': 'Cristian Romero', 'Edad': 26, 'Altura': 1.85, 'Precio': '60 Millones', 'Posicion': 'Defensa Central'},
}
